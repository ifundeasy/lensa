...
module.exports = function (args, app) {
     ...
     ** http data resource
     ** **************************************************************************/
    var referal = (function (orgId) {
        var groups = {
            field : "name",
            value : {"$nin" : ["Root", "Public"]}
        };
        var organizations = {
            field : "_id",
            value : orgId
        ...
        var categories = {
            field : "",
            value : "",
            foregin : {organizations : organizations}
        };
        var roles = {
            field : "",
            value : "",
        ...
        var procedures = {
            field : "",
            value : "",
            foregin : {categories : categories, roles : roles}
        };
        var steps = {
            field : "",
            value : "",
            foregin : {procedures : procedures}
        };
        var users = {
            field : "",
            value : "",
    ...
    api.use(function (req, res, next) {
        /**
         * todo : authorizing data, filtering which data to be gave
         */
        var ref = referal();
        next();
    });
