...
module.exports = function (args) {
    ...
    router.all('/:col/:rec?', function (req, res) {
        ...
        if (Collection) {
            console.log(W.home + 'libs/getuser');
            // check authorized user
            var getuser = require(W.home + 'libs/getuser');
            getuser(req.cookies[W.name], mongoose.models['user'], function (err, msg) {
                if (err) {
                    var loggedUser = '';
                } else {
                    var loggedUser = msg;
...
>>>>>>> 188643fe52802bb664d6da89ba769c8e28c23024
    });
